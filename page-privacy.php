...
<section class="ly_section hp_ptMd hp_pbLg">
    <div class="ly_inner">
        ...
        <p class="el_privacy_lead">
            整体AMA（以下、当サイト）は、以下のとおり個人情報保護方針を定め、個人情報保護の仕組みを構築し、全スタッフに個人情報保護の重要性の認識と取組みを徹底させることにより、個人情報の保護を推進致します。
        </p>
        <div class="bl_privacy_article hp_mt50 hp_mb50">
            <h3>1.個人情報の管理
            </h3>
            <p>
